class MarketItem extends HTMLElement{
    ...
    constructor(){
        ...
        //market title
        this.marketTitle = document.createElement( "h1" );
        this.marketTitle.classList.add( "goodsTitle" );
        this.container.appendChild( this.marketTitle );
        
        //location
        this.location = document.createElement( "p" );
        this.location.classList.add( "goodsAmount" );
        this.container.appendChild( this.location );

        //when occur
        this.whenOccur = document.createElement( "p" );
        this.whenOccur.classList.add( 'unit-goods' );
        this.container.appendChild( this.whenOccur );
    ...
    attributeChangedCallback( nameAttribute, oldValue, newValue ){
        switch( nameAttribute ){
            ...
            case 'name':
                this.marketTitle.innerText = newValue;
                break;
            // case "location":
            //     this.location.innerText = newValue;
            //     break;
            // case "occur":
            //     this.whenOccur.innerText = newValue;
            //     break;
            case "isnew":
                this.editItem();
                break;
